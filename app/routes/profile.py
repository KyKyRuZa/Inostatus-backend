...
@router.post(
    "/profile/keys", response_model=APIKeyResponse, status_code=status.HTTP_201_CREATED
)
async def create_new_api_key(
    ...
    return create_api_key(
        db, user_id, key_data.name, key_data.key_type or "free", key_data.max_uses or 2
    )
...
async def get_check_history(
    ...
    return get_user_check_history(db, user_id, skip=skip, limit=limit, check_type=type)
